...
#include "stdafx.h"
#include "spitonicbufferplayersynthvoroguiwin32.h"
#include "FreeImage.h"
...
TCHAR szTitle[1024]={L"spitonicbufferplayersynthvoroguiwin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spitonicbufferplayersynthvoroguiwin32class"};				// the main window class name
